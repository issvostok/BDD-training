...
describe "#multiply" do
  ...
  it "multiplies two numbers" do
    ...
    multiply(100, 50).should == 5000
    multiply(0, 0).should == 0
  end

  it "multiplies several numbers" do
    multiply(2,2,2,2,2).should == 32
    multiply(5, 45, 45, 32, 234, 2) == 151632000
    multiply(1,1,1,1,1,1).should == 1
    multiply(1,1,1,1,1,0).should == 0
  end
end
...
describe "#power" do
  it "raises one number to the power of another number" do
    ...
    power(0, 1).should == 0
    power(12314123123123123123, 0).should == 1
    power(2, 3).should == 8
  end
end
